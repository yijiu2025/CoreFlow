...
import { S as L } from './sparkles-CSDhrUXU.js';
import {
  d as b,
  L as x,
  c as t,
...
const B = { class: 'recommend-page-container' },
  N = { class: 'content-container' },
  z = { key: 0, class: 'waterfall-grid' },
  D = { class: 'waterfall-grid' },
  F = { key: 0, class: 'load-more-container' },
  I = ['disabled'],
  M = { key: 1, class: 'load-more-container' },
  P = { key: 2, class: 'empty-state' },
  R = b({
    __name: 'RecommendView',
    setup(A) {
      const {
        activeNav: d,
        filteredItems: i,
                ...
                : e(i).length > 0
                    ...
                    t(
                      ...
                      [
                          ...
                          t(
                            ...
                            m(
                              ...
                              s => (
                                ...
                                p(
                                  g,
                                  { key: s._key ?? s.id, item: s, onClick: e(u), onLike: e(f), onCollect: e(v) },
                                  null,
                                  8,
                        ...
                        e(k)
                          ? (o(),
                            t('div', F, [
                              n(
                                ...
                                [
                                  e(r) ? (o(), p(e(h), { key: 0, class: 'animate-spin', size: 16 })) : S('', !0),
                          ...
                          : (o(),
                            t('div', M, [
                              ...(a[1] || (a[1] = [n('span', { class: 'no-more-text' }, '没有更多推荐了', -1)]))
                            ]))
                      ],
                      64
                    ))
                  : (o(),
                    t('div', P, [
                      ...
                      a[2] || (a[2] = n('div', { class: 'empty-text' }, '暂时没有推荐的内容', -1))
                    ]))
            ])
          ])
        )
  ...
  U = w(R, [['__scopeId', 'data-v-a44e477f']]);
export { U as default };
