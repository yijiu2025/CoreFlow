  ...
  const updateSelection = () => {
    ...
    if (obj) {
      ...
      if (targetObj.type === 'i-text' || targetObj.type === 'textbox' || targetObj.type === 'text') {
        const activeStyles = (targetObj.isEditing && typeof targetObj.getActiveStyles === 'function')
        ...
        textProperties.textUnderline.value = activeStyles.underline !== undefined
          ? activeStyles.underline
          : (targetObj.underline || false)
        textProperties.textStrikethrough.value = activeStyles.linethrough !== undefined
          ? activeStyles.linethrough
          : (targetObj.linethrough || false)
