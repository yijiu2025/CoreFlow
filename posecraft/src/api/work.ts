...
export const workApi = {
  ...
  /** 获取推荐作品（多维加权随机排序） */
  getRecommendedWorks: (params?: { limit?: number }) => service.get('/posecraft/v1/works/recommended', { params }),
  ...
  /** 获取作品详情 */
  getDetail: (id: number) => service.get(`/posecraft/v1/works/${id}`),
  ...
  /** 删除作品 */
  delete: (id: number) => service.delete(`/posecraft/v1/works/${id}`)
};
