<template>
  <PanelSection title="图片编辑" :shortcuts="shortcuts">
    ...
    <div class="ratio-grid">
      <button
        class="ratio-btn"
        :class="{ active: cropAspectRatio === null }"
        @click="$emit('update:cropAspectRatio', null)"
      >
        <span>自由</span>
      </button>
      ...
      <button
        ...
        @click="$emit('update:cropAspectRatio', 4 / 3)"
      >
        <span>4:3</span>
      </button>
      <button
        ...
        @click="$emit('update:cropAspectRatio', 16 / 9)"
      >
        <span>16:9</span>
      </button>
      <button
        class="ratio-btn"
        :class="{ active: cropAspectRatio === 3 / 2 }"
        @click="$emit('update:cropAspectRatio', 3 / 2)"
      >
        <span>3:2</span>
      </button>
      <button
        ...
        @click="$emit('update:cropAspectRatio', 9 / 16)"
      >
        <span>9:16</span>
      </button>
    </div>
...
defineEmits([
  ...
  'cropImage',
  'update:bgOpacity',
  'update:cropAspectRatio',
  'update:currentColor',
  'saveHistory'
]);

const shortcuts = [{ keys: ['Ctrl', 'Z'], label: '撤销' }];
</script>
