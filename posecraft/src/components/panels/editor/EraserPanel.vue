  ...
  <PanelSection title="橡皮擦工具" :shortcuts="shortcuts">
    ...
    <div class="slider-group">
      ...
      <div class="slider-row">
        ...
        <span class="slider-val">{{
          eraserHardness === 0 ? '软' : eraserHardness === 100 ? '硬' : eraserHardness + '%'
        }}</span>
      </div>
    </div>
    ...
    <div class="shape-grid">
      <button
        ...
        @click="$emit('update:eraserShape', 'circle')"
      >
      ...
      <button
        class="shape-btn"
        :class="{ active: eraserShape === 'square' }"
        @click="$emit('update:eraserShape', 'square')"
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
defineEmits([
  'update:eraserSize',
  'update:eraserOpacity',
  'update:eraserHardness',
  'update:eraserShape',
  'update:eraserMode',
  'saveState'
]);
