      ...
      <div class="panel-body">
        ...
        <div class="style-section">
          ...
          <div class="style-grid">
            ...
            >
              <svg width="40" height="4">
                <line x1="0" y1="2" x2="40" y2="2" stroke="currentColor" stroke-width="2" stroke-dasharray="6,4" />
              </svg>
              <span>虚线</span>
            </button>
            <button
            ...
            >
              <svg width="40" height="4">
                <line x1="0" y1="2" x2="40" y2="2" stroke="currentColor" stroke-width="2" stroke-dasharray="2,4" />
              </svg>
              <span>点线</span>
            </button>
          </div>
