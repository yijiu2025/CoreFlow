<template>
  <div>
    <label
      v-if="label"
      class="text-[10px] font-bold uppercase tracking-widest mb-1.5 block flex items-center gap-2"
...
const variantStyles = {
  default: {
    ...
    light:
      'bg-white border-slate-200 text-slate-900 placeholder-slate-400 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10'
  },
  mono: {
