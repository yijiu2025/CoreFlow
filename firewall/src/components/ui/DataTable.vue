<template>
  ...
  >
    <!-- Header -->
    <div
      class="flex items-center px-6 py-3 border-b transition-colors"
    ...
    <!-- Body -->
    <div
      class="divide-y transition-colors overflow-y-auto custom-scrollbar"
    ...
    >
      ...
      <div
        v-if="!data.length"
        class="px-6 py-8 text-center text-[10px] font-bold text-slate-500 uppercase tracking-widest"
      >
        {{ emptyMessage }}
      </div>
    </div>
