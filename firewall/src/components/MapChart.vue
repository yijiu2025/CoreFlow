<template>
  <div class="w-full h-full relative" ref="containerRef">
    ...
    >
      ...
      >
        ...
        <span class="tracking-tight"
          >{{ props.serverNode?.country || $t('common.unknown') }} ·
          {{ props.serverNode?.region || $t('common.unknown') }}</span
        >
      </div>
    </div>
    ...
    <!-- 背景光晕 -->
    <div
      class="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(6,182,212,0.07),transparent_70%)] pointer-events-none"
    ></div>
  </div>
</template>
          ...
          areaColor: {
            ...
            colorStops: props.isDark
              ...
              : [
                  ...
                  { offset: 1, color: 'rgba(165, 180, 252, 0.1)' }
                ]
          },
