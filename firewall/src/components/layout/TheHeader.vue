<template>
  <header
    class="flex justify-between items-center p-4 pointer-events-auto transition-all duration-500"
    ...
    <div class="glass px-6 py-3 rounded-2xl flex items-center gap-6 shadow-xl">
      <div class="flex items-center gap-3">
        ...
        <h1
          ...
          :class="isDarkMode ? 'text-slate-100 glow-text' : 'text-slate-800'"
        >
          CoreFlow Firewall
        </h1>
      </div>
    ...
    <transition name="fade-ui">
      <div v-if="isUiVisible" class="flex gap-2 items-center">
        ...
        <button
          ...
          class="glass w-10 h-10 rounded-xl transition-all shadow-lg flex items-center justify-center"
