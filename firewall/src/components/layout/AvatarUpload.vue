    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div v-if="showEditor" class="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <div
            class="relative w-[400px] rounded-3xl overflow-hidden shadow-2xl border"
          ...
          >
            ...
            <div class="px-6">
              <div
                class="relative w-full aspect-square rounded-2xl overflow-hidden border"
            ...
            <div class="px-6 pt-3 pb-2">
              <div v-if="uploading">
                <div class="h-1.5 rounded-full overflow-hidden" :class="isDarkMode ? 'bg-slate-700' : 'bg-slate-100'">
                  <div
                    class="h-full rounded-full bg-cyan-500 transition-all duration-300"
                    :style="{ width: `${uploadProgress}%` }"
                  ></div>
                </div>
                <p class="text-[10px] text-center mt-1.5" :class="isDarkMode ? 'text-slate-500' : 'text-slate-400'">
                  {{ uploadProgress }}%
                </p>
              </div>
              <div v-else class="flex items-center justify-between">
                ...
                <p class="text-[10px] font-mono" :class="isDarkMode ? 'text-slate-600' : 'text-slate-300'">256×256</p>
              </div>
