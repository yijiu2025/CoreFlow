...
<template>
  <div class="absolute inset-0 z-10 pointer-events-none p-4 pt-20">
    <div class="max-w-7xl mx-auto pointer-events-auto">
      <div
        class="glass rounded-3xl overflow-hidden shadow-2xl h-[calc(100vh-120px)] flex flex-col"
        :class="isDarkMode ? 'bg-slate-950/80 border-white/5' : 'bg-white/90 border-slate-200'"
      >
        <div class="p-4 border-b flex items-center gap-3" :class="isDarkMode ? 'border-white/5' : 'border-slate-100'">
