      ...
      >
        <div class="p-8">
          ...
          <div class="space-y-6">
            ...
            <div
              ref="trackRef"
              class="relative h-10 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-100 dark:border-slate-800 overflow-hidden"
            >
              ...
              <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                <span
                  class="text-[11px] font-medium tracking-tight transition-all duration-300"
                  :class="isSuccess ? 'text-white dark:text-slate-900' : 'text-slate-400'"
                >
                  {{ isSuccess ? '验证成功' : '向右滑动' }}
                </span>
              </div>
              ...
              >
                ...
                <svg
                  ...
                  stroke="currentColor"
                  stroke-width="3"
                  :class="isSuccess ? 'text-white dark:text-slate-900' : ''"
                >
