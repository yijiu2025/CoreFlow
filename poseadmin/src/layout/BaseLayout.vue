...
import { ref } from 'vue';
import { PictureRounded, Menu } from '@element-plus/icons-vue';
...
<template>
  <el-container class="layout-container h-screen bg-gray-50">
    ...
    >
      ...
      <el-menu :default-active="route.path" class="border-r-0 flex-1 overflow-y-auto" :collapse="isCollapse" router>
